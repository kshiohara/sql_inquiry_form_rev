<?php
/* Smarty version 4.3.1, created on 2023-06-15 11:06:09
  from '/Applications/MAMP/htdocs/sql_inquiry_form_rev/mvc_app/Views/contact/confirm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_648a7211d03af1_12817209',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '42a637f0836c83558762d865719749ad835936a3' => 
    array (
      0 => '/Applications/MAMP/htdocs/sql_inquiry_form_rev/mvc_app/Views/contact/confirm.tpl',
      1 => 1686711232,
      2 => 'file',
    ),
  ),
...
function content_648a7211d03af1_12817209 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-lg-6 mx-auto col-md-8">
                ...
                <form action="/contact/complete" method="post" name="confirmForm" class="bg-white p-3 rounded mb-5">
                    <div class="form-group">
                        ...
                        <p id="name"><?php echo htmlspecialchars((string) (($tmp = $_smarty_tpl->tpl_vars['contact']->value['name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
</p>
                    </div>
                    <div class="form-group">
                        <p>フリガナ</p>
                        <p class="err-msg-kana"></p>
                        <p id="kana"><?php echo htmlspecialchars((string) (($tmp = $_smarty_tpl->tpl_vars['contact']->value['kana'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
</p>
                    </div>
                    <div class="form-group">
                        <p>電話番号（数字のみ、ハイフン無し）</p>
                        <p class="err-msg-tel"></p>
                        <p id="tel"><?php echo htmlspecialchars((string) (($tmp = $_smarty_tpl->tpl_vars['contact']->value['tel'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
</p>
                    </div>
                    <div class="form-group">
                        <p>メールアドレス</p>
                        <p class="err-msg-email"></p>
                        <p id="email"><?php echo htmlspecialchars((string) (($tmp = $_smarty_tpl->tpl_vars['contact']->value['email'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
</p>
                    </div>
                    <div class="form-group">
                        <p>お問い合せ内容</p>
                        <p class="err-msg-body"></p>
                        <p id="body"><?php echo htmlspecialchars((string) (($tmp = $_smarty_tpl->tpl_vars['contact']->value['body'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
</p>
                    </div>
